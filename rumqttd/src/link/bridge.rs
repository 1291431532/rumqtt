...
use crate::{
    ...
    protocol::v4::{
        connect::Connect,
        pingreq, qos as u8_to_qos,
        subscribe::{self, SubscribeFilter},
        Packet, QoS,
    },
    router::Event,
    BridgeConfig, ConnectionId, Transport,
};
...
pub async fn bridge_launch(
    ...
    let Link(mut tx, _rx) = Link::new("bridge", router_tx, true)?;
